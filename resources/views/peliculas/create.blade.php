<x-layouts::app :title="__('Nueva Película')">
    <div class="max-w-3xl mx-auto px-6 py-8">

        <div class="mb-8">
            <div class="flex items-center gap-3 mb-1">
                <div class="h-7 w-1 rounded-full bg-red-600"></div>
                <h1 class="text-3xl font-bold text-white tracking-tight">Nueva Película</h1>
            </div>
            <p class="text-sm text-zinc-500 ml-4">Agrega un nuevo título al catálogo</p>
        </div>
